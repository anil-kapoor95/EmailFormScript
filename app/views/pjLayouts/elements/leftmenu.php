...
<div class="leftmenu-middle">
	<ul class="menu">
		<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminForms&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminForms' ? 'menu-focus' : NULL; ?>"><span class="menu-forms">&nbsp;</span><?php __('menuForms'); ?></a></li>
		<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminSubmissions&amp;action=pjActionIndex" class="<?php echo $_GET['controller'] == 'pjAdminSubmissions' ? 'menu-focus' : NULL; ?>"><span class="menu-submissions">&nbsp;</span><?php __('lblSubmissions'); ?></a></li>
		<?php
		if ($controller->isAdmin())
		{
			?>
			<li><a href="<?php echo $_SERVER['PHP_SELF']; ?>?controller=pjAdminOptions&amp;action=pjActionIndex" class="<?php echo ($_GET['controller'] == 'pjAdminOptions' && in_array($_GET['action'], array('pjActionIndex', 'pjActionEmailSettings'))) || in_array($_GET['controller'], array('pjAdminLocales', 'pjBackup', 'pjLocale')) ? 'menu-focus' : NULL; ?>"><span class="menu-options">&nbsp;</span><?php __('menuOptions'); ?></a></li>

...
class pjAppController extends pjController
{
	...
	{
	    $arr = pjUserModel::factory()->limit(1)->orderBy("id ASC")->findAll()->getDataIndex(0);
	    return isset($arr['email']) && !empty($arr['email']) ? $arr['email'] : NULL;
	}
}
?>